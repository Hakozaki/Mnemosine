<div class="row" style="padding-top: 10px"> 
    ...
    <div class="form-group{{ $errors->has('talento') ? 'has-error' : '' }}" >
        ...
        <div class="input-group">
            <select id="talento" name="talento" class="form-control selectpicker" data-live-search="true" value="">                                   
            ...
            <span class="input-group-btn"> <a class="btn btn-info" onclick="insere()">Adicionar Talento</a></span>
        </div>
    </div>                                                        
